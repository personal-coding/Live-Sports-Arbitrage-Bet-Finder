...
The programs use multithreading to make them as fast as possible to find arbitrage opportunities. Also, the program uses the [undetected-chromedriver-modified package](https://pypi.org/project/undetected-chromedriver-modified/) to help avoid bot detection.
