...
The programs use multithreading to make them as fast as possible to find arbitrage opportunities. Also, the program uses the [undetected-chromedriver-modified](https://pypi.org/project/undetected-chromedriver-modified/) package o help avoid bot detection.
